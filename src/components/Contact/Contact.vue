<template>
  <div class="contact">
    <v-container>
      <v-row>
        <v-col cols="12">
          <a href="https://www.facebook.com/engin.sasmaz93?ref=bookmarks" target="_blank">
          ...
          <a href="https://www.linkedin.com/in/engin-sasmaz-17874177/" target="_blank">
            <svg style="width:24px;height:24px" viewBox="0 0 24 24">
          ...
          <a href="https://github.com/Enginovic" target="_blank">
            <svg style="width:24px;height:24px" viewBox="0 0 24 24">
